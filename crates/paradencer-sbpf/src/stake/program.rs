...
use paradencer_ids::{STAKE_PROGRAM_ID, VOTE_PROGRAM_ID};
...
fn minimum_stake_balance() -> u64 {
    ...
    let lpby = paradencer_constants::economics::DEFAULT_LAMPORTS_PER_BYTE_YEAR;
    let threshold = paradencer_constants::economics::DEFAULT_EXEMPTION_THRESHOLD as u64;

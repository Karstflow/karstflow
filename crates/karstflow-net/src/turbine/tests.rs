...
#[test]
fn test_broadcaster_integration() {
...
#[test]
fn test_retransmit_service_integration() {
...
fn test_broadcast_manager() {
    ...
    let broadcaster1 = Arc::new(ShredBroadcaster::new(Arc::clone(&transport), stats.clone()));
    let broadcaster2 = Arc::new(ShredBroadcaster::new(transport, stats));

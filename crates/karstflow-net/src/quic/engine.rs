...
impl QuicEngine {
    ...
    fn process_long_header_packet(
        ...
        if version != karstflow_constants::network::QUIC_VERSION_1 {
    ...
    fn compute_state_counts(&self) -> [u64; karstflow_constants::network::CONN_STATE_COUNT] {
        let mut counts = [0u64; karstflow_constants::network::CONN_STATE_COUNT];

...
use karstflow_constants::network::{XDP_FRAME_SIZE, XDP_UMEM_ALIGN};
...
impl Default for UmemConfig {
    fn default() -> Self {
        Self {
            frame_count: karstflow_constants::network::XDP_DEFAULT_FRAME_COUNT,
            frame_size: XDP_FRAME_SIZE,
            headroom: karstflow_constants::network::XDP_HEADROOM,
        }
    }
}

use karstflow_config::ConfigError;
use karstflow_observability::ObservabilityError;
use karstflow_rpc::RpcError;
use karstflow_runtime::RuntimeError;
use thiserror::Error;
...
pub enum ControlPlaneError {
    ...
    Topology(#[from] karstflow_topology::TopologyError),
    ...
    #[error("identity keypair path is required for 'keys' command (set KARSTFLOW_IDENTITY_KEYPAIR_PATH)")]

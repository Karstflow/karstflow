...
use paradencer_consensus::VoteAccountCache;
use paradencer_net::{ClusterInfo, ContactInfo};
...
mod tests {
    ...
    fn make_contact(node_id: [u8; 32], shred_version: u16) -> ContactInfo {
        ...
        ContactInfo {
            node_id: paradencer_net::NodeId(node_id),
            gossip_addr: addr,
            tpu_addr: addr,
            tpu_quic_addr: addr,
            repair_addr: addr,
    ...
    fn wfs_timeout() {
        ...
        let ci = ContactInfo {
            node_id: paradencer_net::NodeId([1u8; 32]),
            gossip_addr: addr,
            tpu_addr: addr,
            tpu_quic_addr: addr,
            repair_addr: addr,

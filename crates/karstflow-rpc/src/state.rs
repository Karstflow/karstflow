...
pub trait BankAccessProvider: Send + Sync {
    ...
    fn get_balance(&self, pubkey: &karstflow_types::Pubkey, commitment: RpcCommitment) -> u64;
    ...
    fn get_signatures_for_address(
        &self,
        _address: &karstflow_types::Pubkey,
        _limit: usize,
    ...
    fn request_airdrop(
        &self,
        _pubkey: &karstflow_types::Pubkey,
        _lamports: u64,
...
pub struct TransactionSimulationResponse {
    ...
    pub accounts: Vec<(karstflow_types::Pubkey, Option<karstflow_types::Account>)>,

//! Batch signature verification for transactions using paradencer-crypto
//!
//! This module provides optimized batch verification of transaction signatures
//! using the high-performance crypto primitives from paradencer-crypto.

use bytes::Bytes;
use paradencer_constants::transaction as constants;

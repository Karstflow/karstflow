...
impl PeerSelector {
    pub fn new() -> Self {
        Self {
            ...
            slow_index: 0,
            stage: 0,
            latency_threshold_ms: paradencer_constants::repair::FAST_PEER_LATENCY_MS,
            dirty: false,
        }
    }
    ...
    pub fn select_peer(&mut self) -> Option<PeerId> {
        ...
        let use_slow = self.stage < paradencer_constants::repair::SLOW_PEER_STAGE_FRACTION
        ...
        self.stage = (self.stage + 1) % paradencer_constants::repair::PEER_SELECTION_STAGES;
    ...
    pub fn new() -> Self {
        Self {
            ...
            dedup_interval: Duration::from_millis(
                paradencer_constants::repair::REQUEST_DEDUP_INTERVAL_MS,
            ),

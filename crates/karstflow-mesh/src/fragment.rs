...
use karstflow_constants::ipc::{CTL_EOM_BIT, CTL_ERR_BIT, CTL_ORIGIN_SHIFT, CTL_SOM_BIT};
...
pub fn chunk_to_offset(chunk: u32) -> usize {
    (chunk as usize) << karstflow_constants::ipc::CHUNK_LG_SIZE
}

/// Convert a byte offset to a chunk index.
#[inline]
pub fn offset_to_chunk(offset: usize) -> u32 {
    (offset >> karstflow_constants::ipc::CHUNK_LG_SIZE) as u32
}
...
mod tests {
    use super::*;
    use karstflow_constants::ipc::{FRAGMENT_META_ALIGN, FRAGMENT_META_SIZE};

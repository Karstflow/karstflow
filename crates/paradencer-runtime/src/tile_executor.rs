...
use paradencer_mesh::cnc::{TileCnc, TileSupervisor};
use paradencer_mesh::tile_metrics::TileMetrics;
use paradencer_mesh::tile_runner::{run_tile_simple, TileRunnerConfig};
...
mod tests {
    ...
    fn tile_executor_runs_services() {
        ...
        let spec = RuntimeSpec {
            mode: paradencer_core::ExecutionMode::Tile,
            workers: 2,
            run_for_seconds: None,
            pinned_allow_core_sharing: true,
            pinned_core_policy: paradencer_core::PinnedCorePolicy::Adaptive,

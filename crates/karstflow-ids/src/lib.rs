...
/// Source buffer for the stake program's vote-state-v4 upgrade.
///
/// The four addresses below serve upgrades rather than migrations: the program
/// already exists and its bytecode is being replaced. Note that this one is
/// gated by `vote_state_v4` and yet upgrades the *stake* program — the buffer's
/// own name says so upstream, and it is transcribed rather than corrected.
/// BM11F4hqrpinQs28sEZfzQ2fYddivYs4NEAHF6QMjkJF
pub const STAKE_PROGRAM_VOTE_STATE_V4_BUFFER_ADDRESS: Pubkey = Pubkey::new([
    0x99, 0xb4, 0x7d, 0x7b, 0xec, 0x1a, 0x67, 0x97, 0x02, 0xb0, 0xcd, 0xb9, 0xf0, 0xae, 0x0c, 0xac,
    0x0d, 0x79, 0xd4, 0x08, 0xa8, 0x96, 0xe6, 0x1a, 0xe2, 0x65, 0xf9, 0x8f, 0x23, 0xd4, 0x52, 0x64,
]);

/// Source buffer for the stake program's v5 upgrade.
/// 4EBQBjw1kqF1dqUBb6fc5Ji4tCEQgNf9ESGGX3smwXwh
pub const STAKE_PROGRAM_V5_BUFFER_ADDRESS: Pubkey = Pubkey::new([
    0x2f, 0xf3, 0x5e, 0xcd, 0xa7, 0x53, 0x0a, 0xc9, 0x68, 0xb0, 0x35, 0x89, 0x4e, 0x44, 0x4d, 0xa8,
    0x2b, 0x90, 0x26, 0x9b, 0xe7, 0x12, 0xae, 0x92, 0x4c, 0x6f, 0x7a, 0x1a, 0x3a, 0x9f, 0x7b, 0x8c,
]);

/// Source buffer for the stake program's v5.1 upgrade.
/// p51x11QCYMHwuVS1MBcLHKb3MezWyqGS5BEB41CA1dk
pub const STAKE_PROGRAM_V5_1_BUFFER_ADDRESS: Pubkey = Pubkey::new([
    0x0c, 0x0e, 0xd6, 0xde, 0x2b, 0x15, 0xb9, 0x6e, 0xf8, 0xcb, 0x2a, 0xe7, 0xa7, 0x03, 0xd9, 0x2c,
    0x67, 0x72, 0xc2, 0xb7, 0x87, 0x8d, 0x6f, 0xc2, 0x73, 0x1e, 0x7c, 0x30, 0x27, 0x0d, 0x38, 0x2b,
]);

/// Source buffer holding p-token, which replaces the SPL Token program.
/// ptok6rngomXrDbWf5v5Mkmu5CEbB51hzSCPDoj9DrvF
pub const PTOKEN_PROGRAM_BUFFER_ADDRESS: Pubkey = Pubkey::new([
    0x0c, 0x44, 0xe0, 0x0a, 0xa3, 0xdd, 0x2c, 0xf3, 0xb5, 0x43, 0x4d, 0x54, 0x3f, 0x9e, 0xa7, 0xaf,
    0x85, 0x76, 0x97, 0x50, 0xef, 0xc7, 0x5f, 0x16, 0xad, 0xe0, 0xad, 0x88, 0x59, 0xdf, 0xdc, 0x14,
]);

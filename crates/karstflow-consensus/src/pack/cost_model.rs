...
fn is_builtin_program(program_id: &Pubkey) -> bool {
    *program_id == karstflow_ids::SYSTEM_PROGRAM_ID
        || *program_id == karstflow_ids::VOTE_PROGRAM_ID
        || *program_id == karstflow_ids::STAKE_PROGRAM_ID
        || *program_id == karstflow_ids::CONFIG_PROGRAM_ID
        || *program_id == karstflow_ids::BPF_LOADER_PROGRAM_ID
        || *program_id == karstflow_ids::BPF_LOADER_DEPRECATED_PROGRAM_ID
        || *program_id == karstflow_ids::UPGRADEABLE_LOADER_PROGRAM_ID
        || *program_id == karstflow_ids::LOADER_V4_PROGRAM_ID
        || *program_id == karstflow_ids::COMPUTE_BUDGET_PROGRAM_ID
        || *program_id == karstflow_ids::ADDRESS_LOOKUP_TABLE_PROGRAM_ID
}
...
mod tests {
    ...
    fn system_program_id() -> Pubkey {
        karstflow_ids::SYSTEM_PROGRAM_ID
    }

...
use karstflow_constants::economics::PARTITIONED_REWARDS_DISTRIBUTION_SLOTS;
...
mod tests {
    ...
    fn account_database_vote_reader_reads_real_data() {
        ...
        let vote_account = karstflow_storage::Account::new(1_000_000, vote_data, Pubkey::default());
    ...
    fn account_database_vote_reader_returns_none_for_short_data() {
        ...
        let account = karstflow_storage::Account::new(1_000_000, vec![0; 50], Pubkey::default());

...
/// This keeps `karstflow-consensus` independent of `karstflow-sbpf` while
...
use karstflow_sbpf::{SysvarSnapshot, TransactionProcessor};
use std::sync::Arc;
...
impl ExecutionBackend for SbpfExecutionAdapter {
    fn execute_instruction(
        ...
        use karstflow_sbpf::ExecutionContext;

...
pub struct BlockAssembler {
    ...
    buffered_transaction_payloads: Vec<SanitizedTransaction>,
    buffered_cost_units: u64,
    buffered_ticks: u32,
    pending_retry: Option<PendingRetryFragment>,
    pending_retry_transactions: Option<Vec<karstflow_storage::Transaction>>,
...
impl BlockAssembler {
    ...
    fn with_storage_policy_and_stats_and_inputs_with_execution_bridge_override(
        ...
        Ok(Self {
            ...
            buffered_transaction_payloads: Vec::new(),
            buffered_cost_units: 0,
            buffered_ticks: 0,
            pending_retry: None,
            pending_retry_transactions: None,
            dropped_fragments: 0,

...
use karstflow_mesh::{DualReceiver, DualSender};
...
fn full_pipeline_filter_to_fec_to_collector_to_block() {
    ...
    let coding0 = {
        ...
        Shred::new(
            ShredCommonHeader {
                signature: sig,
                variant: karstflow_types::shred::SHRED_CODE_FLAG,
                slot: 100,
                index: 2,
                version: 1,
                fec_set_index: 0,
            },
            ShredVariant::LegacyCoding(karstflow_types::shred::CodingShredHeader {
                num_data_shreds: 2,
                num_coding_shreds: 2,
                position: 0,
            }),

...
//!
//! This module implements the block production pipeline for leader validators in Karstflow.
...
//!
//! ```rust,ignore
//! use karstflow_stages::block_producer::{BlockProducer, BlockProducerConfig};
//! use karstflow_consensus::LeaderSchedule;
...
//! # let validators: Vec<(karstflow_storage::Pubkey, u64)> = vec![];

...
impl VoteIntegration {
    ...
    ) -> Result<Vec<(karstflow_storage::Pubkey, u64, i64)>, VoteIntegrationError> {
...
mod tests {
    use super::*;
    use crate::Entry;
    use karstflow_consensus::{Delegation, StakeTracker, VoteProcessorConfig, VoteState};
    ...
    fn create_test_commitment() -> Arc<Mutex<karstflow_consensus::CommitmentTracker>> {
        Arc::new(Mutex::new(karstflow_consensus::CommitmentTracker::default()))
    }

...
use karstflow_crypto::ed25519_batch::{verify_signature, VerificationResult};
use karstflow_crypto::sha256::Sha256Hasher;
use karstflow_types::shred::{Shred, ShredVariant, SIGNATURE_SIZE};
...
pub fn make_signed_data_shred(
    ...
    use karstflow_crypto::ed25519_batch::sign_message;
...
pub fn make_signed_merkle_data_shred(
    ...
    use karstflow_crypto::ed25519_batch::sign_message;
    use karstflow_types::shred::SHRED_MIN_SIZE;

    let variant_byte = karstflow_constants::shred::SHRED_TYPE_MERKLE_DATA | proof_depth;
    ...
    let shred = karstflow_types::shred::ShredParser::parse(&raw).unwrap();
    match &shred.variant {
...
mod tests {
    use super::*;
    use karstflow_crypto::ed25519_batch::{generate_keypair, sign_message};
    use karstflow_types::shred::{
    ...
    fn make_signed_merkle_data_shred(
        ...
        let mut shred = karstflow_types::shred::ShredParser::parse(&raw).unwrap();

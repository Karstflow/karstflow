...
use paradencer_stages::{MetricsOutputFormat, MetricsOutputTarget};
...
pub fn build_metrics_output_format(
    ...
    if let Ok(format_value) = std::env::var("PARADENCER_METRICS_FORMAT") {
    ...
    match raw {
        Some(value) => match value.to_ascii_lowercase().as_str() {
            ...
            _ => Err(ConfigError::InvalidScope {
                scope: "PARADENCER_METRICS_FORMAT",

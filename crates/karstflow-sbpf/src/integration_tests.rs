...
use karstflow_ids::{STAKE_PROGRAM_ID, SYSTEM_PROGRAM_ID, VOTE_PROGRAM_ID};
...
fn build_tower_sync_data(root: Option<u64>, votes: &[(u64, u32)]) -> Vec<u8> {
    use karstflow_constants::vote_program::INSTRUCTION_TOWER_SYNC;
    let mut data = Vec::new();
...
fn make_stake_account_for_test(lamports: u64) -> Account {
    ...
    use karstflow_constants::stake_program::STAKE_STATE_V2_SIZE;
